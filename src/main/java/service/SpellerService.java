...
//  public void spellerTest(){
//        RestAssured.given()
//                .queryParam("text","responise")
//                .params("lang", "en", "CustomParameter","valueOfParam")
//                .accept(ContentType.JSON)
//                .log().everything()
//                .when()
//                .get("https://speller.yandex.net/services/spellservice.json/checkText")
//                .prettyPeek()
//                .then()
//                .assertThat()
//                .statusCode(HttpStatus.SC_OK)
//                .body(Matchers.allOf(Matchers.stringContainsInOrder(Arrays.asList("responise", "response")), Matchers.containsString("\"code\":1")))
